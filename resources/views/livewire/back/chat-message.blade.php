        ...
        <div x-description="Background overlay, show/hide based on slide-over state." class="absolute inset-0"
            ...
            <div class="fixed inset-y-0 right-0 z-20 flex max-w-full pl-10 sm:pl-16">
                ...
                <div x-show="open" x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700"
                    ...
                    style="display: none">
                    <div class="flex flex-col h-full py-6 bg-white shadow-xl scrollbar dark:bg-gray-700">
                        ...
                        <div class="relative flex-1 px-4 mt-6 sm:px-6 ">
                            ...
                            <div class="absolute inset-0 flex flex-col ">
                                ...
                                <div
                                    class=" right-0 w-full  max-h-[800px] bg-gray-100 overflow-y-auto rounded-t-lg  scrollbar dark:bg-gray-700 left-0 {{$taping?'block':'hidden' }}">
                                    ...
                                    <div class="flex items-start justify-between p-6 space-y-1 bg-gray-100 border-b shadow-lg border-b-gray-300 dark:bg-gray-700 dark:text-white">
                                        <div class="flex-1">
                                    ...
                                    @else
                                    <div class="flex items-start justify-between p-6 bg-gray-200 shadow-lg dark:bg-gray-600 dark:text-white">
                                        <div class="flex-1">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="w-12 h-12 rounded-full"
...
<span id="typingMessage" class="h-20 text-3xl bg-green-500 dark:text-white">....</span>
                                <div class="container absolute bottom-0 left-0 px-3 mx-auto">
                                    
                                    <div
                                        class="flex w-full overflow-y-auto bg-gray-100 rounded-b-lg b ring-2 dark:bg-gray-700">

                                        <x-icons.icon
                                            class="inline-flex items-center px-3 text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-bl-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600"
