<div>
   ...
   <div class="font-sans antialiased h-[800px] flex">
      ...
      <div class="flex-1 flex flex-col bg-gray-700 overflow-hidden">
         ...
         <div class="px-6 py-4 flex-1 overflow-y-scroll" >
            <!-- A message -->
            <div class="border-b border-gray-600 py-3 flex items-start mb-4 text-sm message">
            ...
            <div class="border-b border-gray-600 py-3 flex items-start mb-4 text-sm message">
               ...
               <div class="flex-1 overflow-hidden">
                  ...
                  <p class="text-white leading-normal">Last message !</p>
               </div>
            </div>
            <div class="border-b border-gray-600 py-3 flex items-start mb-4 text-sm message">
               <img src="https://cdn.discordapp.com/embed/avatars/4.png"
            ...
            <div class="border-b border-gray-600 py-3 flex items-start mb-4 text-sm message">
               ...
               <div class="flex-1 overflow-hidden">
                  ...
                  <p class="text-white leading-normal">Last message10 !</p>
               </div>
            </div>
            <div class="border-b border-gray-600 py-3 flex items-start mb-4 text-sm message">
               <img src="https://cdn.discordapp.com/embed/avatars/4.png"
               ...
               <div class="flex-1 overflow-hidden">
                  ...
                  <p class="text-white leading-normal">Last message 20!</p>
               </div>
            </div>
            <!-- A message -->
         </div>
         <div class="pb-6 px-4 flex-none">
            ...
            <div class="left-0 right-0 w-full bg-gray-200 dark:bg-gray-700">
               <div id="typingMessage"
                  class="hidden w-full py-2.5  dark:text-white typing bg-gray-200   px-4  rounded  text-gray-700 font-bold text-sm text-center dark:bg-gray-700">
               </div>
            </div>
         </div>
      </div>
